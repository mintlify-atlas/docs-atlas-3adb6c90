---
title: Changelog
description: Version history and release notes for react-qr-code
---

Complete version history of react-qr-code with bug fixes, features, and improvements.
...
For the complete changelog, visit the [GitHub repository](https://github.com/rosskhanas/react-qr-code/blob/master/CHANGELOG.md).